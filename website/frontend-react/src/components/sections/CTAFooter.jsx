...
export default function CTAFooter() {
  ...
  return (
    <section ref={ref} className={`invitation fade-in-section${inView ? " is-visible" : ""}`} id="get-started">
      ...
      <p className="invitation__subtitle">
        ...
        Vanguard is open source and under active development — grab the code and run it on
        your own hardware.
      </p>
      ...
      <footer className="footer">
        ...
        <a className="footer__github" href={GITHUB_URL} target="_blank" rel="noreferrer" aria-label="Vanguard on GitHub">
